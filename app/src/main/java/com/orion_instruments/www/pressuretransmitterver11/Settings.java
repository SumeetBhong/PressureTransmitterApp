...
public class Settings extends AppCompatActivity {
    ...
    String[] gridViewString={
            "Mode","Relay","Gauge","Transmitter","Data Logger","Calibration","Device Settings","WiFi","About"
    };
    int[] gridViewImageId={
            R.drawable.mode,R.drawable.relay,
            R.drawable.gauge,R.drawable.transmitter,
            R.drawable.datalogger, R.drawable.calibration,
            R.drawable.devicesettings,R.drawable.wifi,
            R.drawable.about
