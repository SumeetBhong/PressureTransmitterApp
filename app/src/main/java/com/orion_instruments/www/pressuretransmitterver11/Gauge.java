...
public class Gauge extends AppCompatActivity {
    TabHost tabHost;
    TextView sensor,textView26, txtString, txtStringLength;
    Button button11;
    String string;
     ...
     //////////////////////////////////////////////////////////////////////////////////////////////
        button11.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
               ...
               textView26.setText("G"+editText20.getText().toString()+","+editText21.getText().toString()+","+editText22.getText().toString()+","+editText23.getText().toString()+","+editText24.getText().toString()+","+editText25.getText().toString()+","+editText26.getText().toString()+","+editText27.getText().toString()+","+
                       String.valueOf(spinner6.getSelectedItemPosition())+","+String.valueOf(spinner7.getSelectedItemPosition())+","+String.valueOf(spinner8.getSelectedItemPosition())+","+String.valueOf(spinner9.getSelectedItemPosition())+"~");
                //
